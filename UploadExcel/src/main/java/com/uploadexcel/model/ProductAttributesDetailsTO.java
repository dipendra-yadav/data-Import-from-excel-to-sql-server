...
public class ProductAttributesDetailsTO {

	String UniqueId;
	String RecordId;
	String SellerIDQualifier;
	String SellerID;
	// Date DateCreated;
	String DateCreated;
	String UpdateStatus;
	...
	public String getIDWPrivateId() {
		return IDWPrivateId;
	}

	public void setIDWPrivateId(String iDWPrivateId) {
		IDWPrivateId = iDWPrivateId;
	}

	String ItemCtrlNumber;
	String IDWitemControllNumber;
	String UPC;
	String GTIN;
	String EANUCC;
	...
	public String getIDWitemControllNumber() {
		return IDWitemControllNumber;
	}

	public void setIDWitemControllNumber(String iDWitemControllNumber) {
	...
	public String getSellerIDQualifier() {
		return SellerIDQualifier;
	}

	public void setSellerIDQualifier(String sellerIDQualifier) {
	...
	public String getItemCtrlNumber() {
		return ItemCtrlNumber;
	}

	public void setItemCtrlNumber(String itemCtrlNumber) {
	...
	public String getIGCC() {
		return IGCC;
	}

	public void setIGCC(String iGCC) {
		IGCC = iGCC;
	}
